...
// }(window.jQuery);
    ...
    var newTime = formatDateTime(new Date());
            ...
            function getYMDHMS(startTime, endTime) {
                ...
                var endArr = [endTime.substring(0, 4), endTime.substring(4, 6), endTime.substring(6, 8), endTime.substring(8, 10), endTime.substring(10, 12), endTime.substring(12, 14)];//åˆ‡åˆ†ç»“æŸæ—¶é—´ä¸ºæ•°ç»„
                ...
                var dateInterval = dateEnd.getTime() - dateStart.getTime() //èŽ·å–æ—¶é—´å·®æ¯«ç§’
                //è®¡ç®—å‡ºç›¸å·®å¤©æ•°
                ...
                // alert('å¤©æ•° ' + days + ' å°æ—¶æ•° ' + hours + ' åˆ†é’Ÿæ•° ' + minutes + ' ç§’æ•° ' + seconds)
